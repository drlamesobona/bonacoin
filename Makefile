...
pkgdatadir = $(datadir)/bonacoin
pkgincludedir = $(includedir)/bonacoin
pkglibdir = $(libdir)/bonacoin
pkglibexecdir = $(libexecdir)/bonacoin
...
ACLOCAL = ${SHELL} /bonacoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /bonacoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /bonacoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /bonacoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = bonacoin-cli
BITCOIN_DAEMON_NAME = bonacoind
BITCOIN_GUI_NAME = bonacoin-qt
BITCOIN_TX_NAME = bonacoin-tx
...
COPYRIGHT_HOLDERS_FINAL = The BonaCoin Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = BonaCoin Core
COPYRIGHT_YEAR = 2017
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /bonacoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = bonacoin
PACKAGE_BUGREPORT = https://github.com/bonacoin-project/bonacoin/issues
PACKAGE_NAME = BonaCoin Core
PACKAGE_STRING = BonaCoin Core 0.14.2
PACKAGE_TARNAME = bonacoin
PACKAGE_URL = https://bonacoin.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /bonacoin
abs_srcdir = /bonacoin
abs_top_builddir = /bonacoin
abs_top_srcdir = /bonacoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /bonacoin/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/BonaCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/BonaCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BonaCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/BonaCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
