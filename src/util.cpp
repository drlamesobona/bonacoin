...
const char * const BITCOIN_CONF_FILENAME = "bonacoin.conf";
const char * const BITCOIN_PID_FILENAME = "bonacoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BonaCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BonaCoin";
#else
    // Unix
    return pathRet / ".bonacoin";
#endif
#endif
}
