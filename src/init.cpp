...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bonacoin-project/bonacoin>";
    const std::string URL_WEBSITE = "<https://bonacoin.org>";
