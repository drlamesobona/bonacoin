...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bonacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bonacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bonacoin transaction") + "\n" +
              "  bonacoin-tx [options] -create [commands]   " + _("Create hex-encoded bonacoin transaction") + "\n" +
              "\n";
