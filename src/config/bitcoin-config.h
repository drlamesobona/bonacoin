...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BonaCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BonaCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bonacoin-project/bonacoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BonaCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BonaCoin Core 0.14.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bonacoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bonacoin.org/"
